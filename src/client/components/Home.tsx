		...
		<>
			<div className={homeStyles.main_container}>
				<div className={homeStyles.main_animation}>
					...
					<div className={homeStyles.outside_border}>
					...
					<div className={homeStyles.middle_border}>
					...
					<div className={homeStyles.text}>
						...
						<div className={homeStyles.preview_text}>
							<div className={homeStyles.textName}>Hi There, I'm Vitalii</div>
							<div className={homeStyles.textDeveloper}>Frontend / Backend  Developer</div>
							<div className={homeStyles.button}>
								<button>Hire Me</button>
								<button className={homeStyles.centerButton}>Let's Talk</button>
								<button>Download CV</button>
							</div>
						</div>

						<div className={homeStyles.socialMedia}>
							<div className={homeStyles.gitHubLogo}>
								<svg viewBox="0 0 1024 1024" width="200" height="200" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
							...
							<div className={homeStyles.telegramLogo}>
								<svg viewBox="0 0 256 256" width="200" height="200" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
							...
							<div className={homeStyles.linkedinLogo}>
								<svg viewBox="0 0 448 512" width="200" height="200" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
